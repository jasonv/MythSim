 ...
 * @todo Get the MythSim icon to load in the top left corner of the window.
 */
public class DatapathFrame
  ...
  MythMap map = null;
  public DatapathFrame(MythSimSwing a, JFrame owner) {
    super("Datapath",
          false, //resizable
          true, //closable
          false, //maximizable
  ...
  void alu(Graphics g, int x, int y) {
    ...
    //g.setColor(Color.BLUE);
    g.drawString("(" + p[MythSimSwing.ALU_SEL] + " " +
                                             MythSimSwing.funcName(p[MythSimSwing.ALU_SEL]) + ")",315,60);
    g.drawString("(" + p[MythSimSwing.C_IN] + ")",280,60);
    g.setColor(Color.BLACK);
